...
public:
  ...
  void fiducialCuts(unsigned int idx = 99999, double xMin = -1000, double xMax = 1000, double yMin = -1000, double yMax = 1000, bool fidcut1=true); // fidcut1=true for old fiducial, false for new fiducial
